Shader "Vivify/SkyboxShader"
{
    Properties
    {
        _BaseColor ("Base Color DAY", Color) = (1, 1, 1)
        _HorizonColor ("Horizon Color DAY", Color) = (1, 1, 1)
        _BaseColorNight ("Base Color NIGHT", Color) = (1, 1, 1)
        _HorizonColorNight ("Horizon Color NIGHT", Color) = (1, 1, 1)
